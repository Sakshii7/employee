  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items" class="@if(Request::segment(1) == "dashboard")active @endif" >
        ...
        <li class="nav-item menu-items" class="@if(Request::segment(1) == "company-list")active @endif">
          <a class="nav-link" href="{{ url('/company-list', []) }}">
        ...
        <li class="nav-item menu-items" class="@if(Request::segment(1) == "employee-list")active @endif">
          <a class="nav-link" href="{{ url('/employee-list', []) }}">
            <span class="menu-icon">
              <i class="mdi mdi-laptop"></i>
            </span>
